...
namespace ApiCatalogoMusicas.InputModel
{
    public class MusicaInputModel
    {

        [Required]
        [StringLength(100, MinimumLength = 3, ErrorMessage = "O nome do musica deve conter entre 3 e 100 caracteres")]
